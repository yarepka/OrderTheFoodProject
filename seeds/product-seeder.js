...
var products = [
  ...
  new Product({
    ...
    price: 13.45,
    type: ["Asian"],
    imagePath: "./img/assian/chilliCrab.jpg",
  }),
  new Product({
    ...
    price: 11.65,
    type: ["Asian"],
    imagePath: "./img/assian/khantokeDinner.jpg",
  }),
  new Product({
    title: "Curry Fesat",
    ...
    price: 15.99,
    type: ["Asian"],
    imagePath: "./img/assian/curryFesat.jpg",
  }),
  new Product({
    title: "Momos",
    ...
    price: 12.25,
    type: ["Asian"],
    imagePath: "./img/assian/momos.jpg",
  }),
  new Product({
    title: "Kimchi",
    ...
    price: 18.95,
    type: ["Asian"],
    imagePath: "./img/assian/kimchi.jpg",
  }),
  new Product({
    title: "Shan Noodles",
    ...
    price: 11.25,
    type: ["Asian"],
    imagePath: "./img/assian/shanNoodles.jpg",
  }),
];
